...
am_DLC_colors_OBJECTS = src/main.$(OBJEXT) src/DLC_plot.$(OBJEXT) \
	src/DLC_colors.$(OBJEXT)
...
SOURCES = $(DLC_colors_SOURCES)
DIST_SOURCES = $(DLC_colors_SOURCES)
ETAGS = etags
CTAGS = ctags
...
DLC_colors_SOURCES = include/DLC_colors.h src/main.cc src/DLC_plot.cc src/DLC_colors.cc 
all: config.h
...
src/DLC_plot.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/DLC_colors.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
DLC_colors$(EXEEXT): $(DLC_colors_OBJECTS) $(DLC_colors_DEPENDENCIES) $(EXTRA_DLC_colors_DEPENDENCIES) 
...
include src/$(DEPDIR)/DLC_plot.Po
